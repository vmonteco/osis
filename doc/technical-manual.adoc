...
environment and other system dependencies:
    ...
    $ sudo apt-get install build-essential python-virtualenv libjpeg-dev libpng-dev gettext
...
The demonstration data also create several other users.

Before running the application we have a last step to do, which is running compiling 
