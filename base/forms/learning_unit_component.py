...
class LearningUnitComponentEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'hourly_volume_total_annual': forms.TextInput(attrs={'type': 'number', 'step': "{}".format(STEP_HALF_INTEGER)}),
            'hourly_volume_partial_q1': forms.TextInput(attrs={'type': 'number','step': "{}".format(STEP_HALF_INTEGER)}),
            'hourly_volume_partial_q2': forms.TextInput(attrs={'type': 'number','step': "{}".format(STEP_HALF_INTEGER)}),
            'volume_declared_vacant': forms.TextInput(attrs={'type': 'number', 'step': "{}".format(STEP_HALF_INTEGER)}),
        },
