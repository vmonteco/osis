...
urlpatterns = [
    ...
    url(r'^educationgroups/', include([
        ...
        url(r'^(?P<education_group_year_id>[0-9]+)/', include([
            url(r'^$', education_group.EducationGroupRead.as_view(), name='education_group_read'),
            url(r'^update/$', update_education_group, name="update_education_group"),
            url(r'^diplomas/$', education_group.EducationGroupDiplomas.as_view(), name='education_group_diplomas'),
