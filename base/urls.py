...
urlpatterns = [
    ...
    url(r'^learning_units/', include([
        ...
        url(r'^reset/by_activity/$', base.views.search.reset_filter_by_activity, name="reset_filter_by_activity"),
        url(r'^reset/by_service_course/$', base.views.search.reset_filter_by_service_course,
            name="reset_filter_by_service_course"),
        url(r'^reset/by_borrowed_course/$', base.views.search.reset_filter_by_borrowed_course,
            name="reset_filter_by_borrowed_course"),
        url(r'^reset/by_proposal/$', base.views.search.reset_filter_by_proposal, name="reset_filter_by_proposal"),
        url(r'^reset/by_external/$', base.views.search.reset_filter_by_external, name="reset_filter_by_external"),
        url(r'^reset/by_summary/$', base.views.search.reset_filter_by_summary, name="reset_filter_by_summary"),
    ])),
