...
urlpatterns = [
    ...
    url(r'^learning_units/', include([
        ...
        url(r'^(?P<learning_unit_year_id>[0-9]+)/', include([
            ...
            url(r'^delete/$', learning_unit.delete_from_given_learning_unit_year, name="learning_unit_delete"),
            url(r'^delete_full/$', learning_unit.delete_all_learning_units_year, name="learning_unit_delete_all"),
        ])),
