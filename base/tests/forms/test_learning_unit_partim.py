    ...
    def test_save(self):
        ...
        self.assertEqual(
            LearningComponentYear.objects.filter(
                learning_container_year=saved_instance.learning_container_year, type=LECTURING
            )[0].acronym, "PM1")
        self.assertEqual(
            LearningComponentYear.objects.filter(
                learning_container_year=saved_instance.learning_container_year, type=PRACTICAL_EXERCISES
            )[0].acronym, "PP1")
