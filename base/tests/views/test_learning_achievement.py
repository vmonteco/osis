...
from base.business.learning_units.achievement import DELETE
...
class TestLearningAchievementActions(TestCase):
    ...
    def test_learning_achievement_save(self):
        ...
        expected_redirection = reverse("learning_unit_specifications",
                                       kwargs={'learning_unit_year_id': self.learning_unit_year.id})+"?anchor={}".format(learning_achievement.id)
