...
class TestOfferYearCalendar(TestCase):
    ...
    def test_compute_deadline_by_offer_year_calendar(self):
        deadlines = [i.deadline for i in self.session_exam_deadlines]
        print(deadlines)

        compute_deadline_by_offer_year_calendar(self.offer_year_calendar)

        new_deadlines = [i.deadline for i in self.session_exam_deadlines]
        self.assertListEqual(deadlines, new_deadlines)
        print(self.session_exam_deadlines)
