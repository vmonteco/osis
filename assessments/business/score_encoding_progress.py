...
class ScoreEncodingProgress:
    def __init__(self, **kwargs):
        ...
        self.learning_unit_year_title = self.get_complete_title(
    ...
    def get_complete_title(self, common_title, specific_title):
        return ' - '.join(filter(None, [common_title, specific_title]))
